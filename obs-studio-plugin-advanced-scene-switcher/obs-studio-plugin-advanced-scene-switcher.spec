...
%changelog
* Mon Jul 06 2026 Tarulia <mihawk.90+git@googlemail.com> - 1.35.0-1
- new version
...
* Thu May 28 2026 Tarulia <mihawk.90+git@googlemail.com> - 1.34.1-1
- new version

* Mon May 25 2026 Tarulia <mihawk.90+git@googlemail.com> - 1.34.0-1
- new version

* Sat Apr 04 2026 Tarulia <mihawk.90+git@googlemail.com> - 1.33.1-1
- new version

* Mon Mar 16 2026 Tarulia <mihawk.90+git@googlemail.com> - 1.32.9-1
- new version

* Fri Feb 20 2026 Tarulia <mihawk.90+git@googlemail.com> - 1.32.8-1
- new version
